...
void sorting(string *p, int col ,int first,int end){ //파라미터 배열 , 열 번호 ,행의 첫번째 인덱스,행의 마지막 인덱스 
    ...
    { 
        ...
        else if (p[rear][col]=='\0' && p[front][col]=='\0'){// 문자열이 null값이 같을 때
            return;
        }
...
void sorting(int *p, int col ,int first,int end){ //파라미터 배열 , 열 번호 ,행의 첫번째 인덱스,행의 마지막 인덱스 
